...
public class CarregadorAbsoluto {
    ...
    public ResultadoCarregamento carregar(String codigoObjeto) {
        ...
        try {
                ...
                switch (tipo) {
                    ...
                    case 'T':
                        if (!temHeader) {
                            ...
                            return new ResultadoCarregamento(0, inicioPrograma, tamanhoPrograma, erros);
                        }
            ...
            return new ResultadoCarregamento(enderecoExecucao, inicioPrograma, tamanhoPrograma, erros);
    ...
    private void processarHeader(String linha) {
        ...
        this.inicioPrograma = inicio;
        this.tamanhoPrograma = tamanho;
